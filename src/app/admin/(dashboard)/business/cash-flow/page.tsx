    ...
    <div className="space-y-6 max-w-5xl mx-auto" dir="rtl">
      ...
      <div className="bg-[var(--admin-bg-surface)] border border-[var(--admin-border-base)] rounded-xl overflow-hidden shadow-sm animate-in fade-in slide-in-from-bottom-2">
        <div className="p-6 bg-[var(--admin-bg-base)] border-b border-[var(--admin-border-base)]">
          <h2 className="text-xl font-bold text-[var(--admin-text-base)]">قائمة التدفقات النقدية (Cash Flow Statement)</h2>
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            <h3 className="font-bold text-lg border-b border-[var(--admin-border-base)] pb-2 mb-4 text-[var(--admin-text-base)]">التدفقات النقدية من الأنشطة التشغيلية</h3>
            <div className="flex justify-between py-2 text-[var(--admin-text-subtle)]">
              <span>المقبوضات النقدية من العملاء</span>
            ...
            <div className="flex justify-between py-2 text-[var(--admin-text-subtle)]">
              <span>المدفوعات النقدية للمصروفات التشغيلية</span>
            ...
            <div className="flex justify-between py-2 font-bold border-t border-[var(--admin-border-light)] mt-2 pt-2 bg-[var(--admin-bg-base)] px-2 rounded">
              <span className="text-[var(--admin-text-base)]">صافي التدفق النقدي من الأنشطة التشغيلية</span>
              <span className={summary.netProfit > 0 ? "text-[var(--admin-success)]" : "text-[var(--admin-danger)]"}>{formatCurrency(summary.netProfit)}</span>
            </div>
          </div>

          {/* Investing Activities */}
          <div>
            <h3 className="font-bold text-lg border-b border-[var(--admin-border-base)] pb-2 mb-4 text-[var(--admin-text-base)]">التدفقات النقدية من الأنشطة الاستثمارية</h3>
            <div className="flex justify-between py-2 text-[var(--admin-text-subtle)]">
              <span>شراء أصول ثابتة</span>
              <span>({formatCurrency(summary.totalAssets)})</span>
            </div>
            <div className="flex justify-between py-2 font-bold border-t border-[var(--admin-border-light)] mt-2 pt-2 bg-[var(--admin-bg-base)] px-2 rounded">
              <span className="text-[var(--admin-text-base)]">صافي التدفق النقدي من الأنشطة الاستثمارية</span>
              <span className="text-[var(--admin-danger)]">({formatCurrency(summary.totalAssets)})</span>
            </div>
          </div>

          {/* Financing Activities */}
          <div>
            <h3 className="font-bold text-lg border-b border-[var(--admin-border-base)] pb-2 mb-4 text-[var(--admin-text-base)]">التدفقات النقدية من الأنشطة التمويلية</h3>
            <div className="flex justify-between py-2 text-[var(--admin-text-subtle)]">
              <span>زيادة في رأس المال</span>
              <span>{formatCurrency(summary.totalCapital)}</span>
            </div>
            <div className="flex justify-between py-2 text-[var(--admin-text-subtle)]">
              <span>الالتزامات (قروض/ديون جديدة)</span>
              <span>{formatCurrency(summary.totalLiabilities)}</span>
            </div>
            <div className="flex justify-between py-2 font-bold border-t border-[var(--admin-border-light)] mt-2 pt-2 bg-[var(--admin-bg-base)] px-2 rounded">
              <span className="text-[var(--admin-text-base)]">صافي التدفق النقدي من الأنشطة التمويلية</span>
              <span className="text-[var(--admin-success)]">{formatCurrency(summary.totalCapital + summary.totalLiabilities)}</span>
            </div>
          </div>
          ...
          <div className="mt-8">
            <div className="flex justify-between py-4 text-xl font-bold border-y-2 border-[var(--admin-border-strong)] bg-[var(--admin-bg-base)] px-4 rounded">
              <span className="text-[var(--admin-text-base)]">الرصيد النقدي في نهاية الفترة</span>
              <span className={summary.cashFlow > 0 ? "text-[var(--admin-success)]" : "text-[var(--admin-danger)]"}>
