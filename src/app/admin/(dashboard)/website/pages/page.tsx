...
const fields: Record<PageKey, Field[]> = {
  home: [
    ...
    { key: "home_hero_image", label: "Ảnh banner 1", section: "Banner chính", type: "image" },
    { key: "home_hero_image_2", label: "Ảnh banner 2", section: "Banner chính", type: "image" },
    { key: "home_hero_image_3", label: "Ảnh banner 3", section: "Banner chính", type: "image" },
    { key: "home_hero_image_4", label: "Ảnh banner 4", section: "Banner chính", type: "image" },
