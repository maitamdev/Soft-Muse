        ...
        <div key={event.id} className="relative flex gap-4">
          <div className="flex flex-col items-center">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[var(--admin-primary-muted)] text-[var(--admin-primary)] ring-4 ring-[var(--admin-bg-card)]">
              <span className="text-xs font-bold">{event.adminName.charAt(0)}</span>
            </div>
          ...
          <div className="flex flex-col pb-6">
            <div className="flex items-center gap-2">
              <span className="font-semibold text-[var(--admin-text-base)]">{event.adminName}</span>
            ...
            <p className="text-sm text-[var(--admin-text-muted)] mt-1">{event.description}</p>
            <div className="flex items-center gap-3 mt-2 text-xs text-[var(--admin-text-subtle)]">
              ...
              <span>•</span>
              <span dir="ltr">IP: {event.mockIp}</span>
            </div>
