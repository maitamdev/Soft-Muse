...
export function AuroraPanel() {
 ...
 {/* Aurora field */}
 <div aria-hidden className="pointer-events-none absolute inset-0"> <div
 ...
 {/* Top: wordmark + kicker */}
 <div className="relative aura-enter"> <AuraWordmark size="lg" /> <p className="mt-3 text-sm font-medium tracking-[0.18em] text-[var(--admin-primary)]">
 {adminAr.login.brandKicker}
 </p> </div>

 {/* Middle: headline + tagline */}
 <div className="relative aura-enter" style={{ animationDelay: "0.08s" }}> <h1
 ...
 </h1> <p className="mt-4 max-w-md text-[15px] leading-relaxed text-[var(--admin-text-muted)]">
 {adminAr.login.brandTagline}
 </p> <ul className="mt-9 grid max-w-md grid-cols-2 gap-3">
 ...
 > <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-[var(--admin-radius-sm)] bg-[var(--admin-primary-muted)] text-[var(--admin-primary)]"> <Icon size={17} stroke={1.7} /> </span> <span className="text-[13px] font-medium text-[var(--admin-text-base)]">
 {label}
 </span> </li>
 ))}
 </ul> </div>
 ...
 > <span className="inline-flex items-center gap-1.5"> <IconShieldLock size={15} stroke={1.7} />
