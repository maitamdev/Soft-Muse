...
export function AdminLayoutWrapper({ children }: { children: React.ReactNode }) {
 ...
 return (
 <PermissionProvider> <div className={`admin-theme ${GeistSans.variable} flex h-screen overflow-hidden antialiased`}> <CommandPalette />
 ...
 {/* Main */}
 <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-[var(--admin-bg-base)]"> <Topbar setIsMobileOpen={setIsMobileOpen} /> <main className="flex-1 overflow-y-auto"> <div className="max-w-screen-2xl mx-auto p-4 md:p-6 lg:p-8"> <PageGuard>{children}</PageGuard> </div> </main> </div> <Toaster
 position="top-left"
 richColors
 dir="ltr"
 toastOptions={{
