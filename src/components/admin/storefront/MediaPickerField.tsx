...
const GALLERY_IMAGES = [
 { src: "/images/campaign/campaign_1.png", label: "1" },
 { src: "/images/campaign/campaign_2.png", label: "2" },
 { src: "/images/campaign/campaign_3.png", label: "3" },
 { src: "/images/campaign/campaign_4.png", label: "4" },
 { src: "/images/campaign/campaign_5.png", label: "5" },
 { src: "/images/campaign/campaign_6.png", label: "6" },
 { src: "/images/flatlay/flatlay_1.png", label: "1" },
 { src: "/images/flatlay/flatlay_2.png", label: "2" },
 { src: "/images/detail/detail_fabric.png", label: "" },
 { src: "/images/lifestyle/lifestyle_interior.png", label: "" },
 { src: "/images/products/product_evening_gown.png", label: "" },
 { src: "/images/products/product_linen_set.png", label: "linen" },
 { src: "/images/products/product_silk_blouse.png", label: "" },
 { src: "/images/products/product_winter_coat.png", label: "mùa đông" },
 { src: "/aura_hero_campaign.png", label: "Hero Campaign" },
 { src: "/aura_packaging_mockup.png", label: "Đónggói" },
 { src: "/aura-logo.png", label: "AURA" },
 { src: "/logo.svg", label: "SVG Logo" },
];
...
export function MediaPickerField({ label, value, onChange, className }: MediaPickerFieldProps) {
 ...
 {/* Header */}
 <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--admin-border-light)] shrink-0"> <div className="flex items-center gap-2"> <IconPhoto size={18} className="text-[var(--admin-primary)]" /> <h2 className="font-bold text-sm text-[var(--admin-text-base)]">Thư viện media</h2> </div> <button
 type="button"
 onClick={() => setOpen(false)}
 className="p-1.5 rounded-[var(--admin-radius-md)] hover:bg-[var(--admin-bg-hover)] text-[var(--admin-text-muted)]"
 > <IconX size={18} /> </button> </div>

 {/* Image gallery */}
 <div className="flex-1 overflow-y-auto p-4 custom-scrollbar"> <p className="text-xs font-semibold text-[var(--admin-text-muted)] uppercase tracking-wide mb-3">
 Hình ảnh trong</p> <div className="grid grid-cols-4 sm:grid-cols-5 gap-2">
 ...
 {value === img.src && (
 <div className="absolute inset-0 bg-[var(--admin-primary)]/20 flex items-center justify-center"> <span className="text-white text-xs font-bold bg-[var(--admin-primary)] rounded-full px-2 py-0.5">✓</span> </div>
 )}
 ...
 {/* Custom URL input */}
 <div className="shrink-0 border-t border-[var(--admin-border-light)] p-4 space-y-2"> <p className="text-xs font-semibold text-[var(--admin-text-muted)]">Tùy chỉnh</p> <div className="flex gap-2"> <input
 type="text"
 value={customUrl}
 ...
 > <IconUpload size={14} /> </button> </div> <p className="text-[10px] text-[var(--admin-text-subtle)]">
 Hình ảnh từThiết bị Supabase Storage
 </p> </div> </div> </div>
 )}
 </div>
 );
