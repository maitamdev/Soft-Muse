...
export default function RecentlyViewed() {
 ...
 return (
 <section className="w-full bg-background-secondary border-t border-brand-border py-16 md:py-24 overflow-hidden"> <div className="max-w-[1280px] mx-auto px-6 md:px-12"> <motion.div 
