      ...
      {show && (
        ...
        >
          ...
          <div className="absolute inset-0 opacity-[0.03] pointer-events-none">
            <div className="absolute left-1/4 top-0 bottom-0 w-[1px] bg-background-primary" />
            <div className="absolute left-2/4 top-0 bottom-0 w-[1px] bg-background-primary" />
            <div className="absolute left-3/4 top-0 bottom-0 w-[1px] bg-background-primary" />
          </div>
          ...
          <div className="flex flex-col items-center relative z-10">
            ...
            >
              ...
              <span className="font-serif text-[10px] text-accent tracking-[0.3em] uppercase">
                2026 CAMPAIGN
              </span>
              <div className="w-8 h-[1px] bg-accent/40" />
            </motion.div>
          ...
          <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-48 h-[1px] bg-background-primary/20">
            <motion.div
              initial={{ width: "0%" }}
              animate={{ width: "100%" }}
