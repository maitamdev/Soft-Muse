...
export let mockCustomers: Customer[] = [
  {
    ...
    cartItemsCount: 0,
    reviewsCount: 2,
    favoriteCategory: 'الفساتين',
    favoriteBrand: 'AURA',
    favoriteColor: 'أسود',
    notes: 'عميلة VIP، تفضل فساتين السهرة الكلاسيكية.',
    internalNotes: [
      { id: 'in_1', adminName: 'Admin', text: 'تفضل التواصل عبر الواتساب', date: new Date(Date.now() - 10 * 86400000).toISOString() }
    ],
    tags: ['VIP', 'سهرة', 'دائمة'],
    ...
    addresses: [
      {
        id: 'addr_1',
        label: 'المنزل',
        street: 'شارع العليا، حي الياسمين',
        city: 'الرياض',
    ...
    activities: [
      { id: 'act_1', type: 'order',        description: 'طلب جديد #10024',          date: new Date(Date.now() - 2 * 86400000).toISOString() },
      { id: 'act_2', type: 'review',       description: 'تقييم فستان سهرة حريري',    date: new Date(Date.now() - 5 * 86400000).toISOString() },
      { id: 'act_3', type: 'login',        description: 'تسجيل دخول',               date: new Date(Date.now() - 86400000).toISOString() },
      { id: 'act_4', type: 'registration', description: 'تم إنشاء الحساب',           date: new Date(Date.now() - 30 * 86400000).toISOString() }
    ],
  ...
  },
  {
    ...
    addresses: [],
    activities: [
      { id: 'act_5', type: 'order',        description: 'طلب جديد #10023',          date: new Date(Date.now() - 10 * 86400000).toISOString() },
      { id: 'act_6', type: 'registration', description: 'تم إنشاء الحساب',           date: new Date(Date.now() - 90 * 86400000).toISOString() }
    ],
