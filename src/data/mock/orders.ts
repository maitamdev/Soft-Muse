...
export let mockOrders: Order[] = [
 ...
 paymentMethod: '',
 shippingMethod: '',
 shippingAddress: 'TP. Hồ Chí Minh, mã,',
 internalNotes: [],
 timeline: [
 { status: 'pending', timestamp: new Date().toISOString(), note: 'đãĐơn hàng Khách hàng' }
 ],
 ...
 shippingMethod: '',
 shippingAddress: ',,',
 internalNotes: [{ id: 'note_1', adminName: 'Admin', text: 'đã giao hàng', date: new Date(Date.now() - 2 * 86400000).toISOString() }],
 timeline: [
