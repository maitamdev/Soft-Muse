...
const DEFAULT_SETTINGS: SiteSettings = {
 ...
 address: { country: 'SA', city: 'TP. Hồ Chí Minh', district: '', street: '', postalCode: '', buildingNo: '', additionalNumber: '' },
 workingHours: [],
 socialLinks: [],
 defaultLanguage: 'vi',
 defaultCurrency: 'VND',
 ...
 cookieBanner: { isEnabled: false, textAr: 'Chúng tôi dùng cookie để cải thiện trải nghiệm của bạn.', buttonLabelAr: 'Đồngý' },
 popup: { isEnabled: false, triggerType: 'time_delay', triggerValue: 5000, imageUrl: '', titleAr: '', subtitleAr: '', showOnce: true },
 maintenanceMode: { isEnabled: false, messageAr: 'Website đang bảo trì', allowedIPs: [] },
 },
 orders: {
 ...
 taxRate: 0.15, taxIncluded: false, taxLabelAr: 'VAT (15%)',
 freeShippingThreshold: 0, defaultShippingFee: 0,
 },
 finance: {
 defaultCurrency: 'VND', currencySymbol: 'đ', currencyPosition: 'after',
 ...
 defaultFolders: [
 { id: 'f_products', nameAr: 'Sản phẩm', slug: 'products', order: 0 },
 { id: 'f_categories', nameAr: 'Danh mục', slug: 'categories', order: 1 },
 { id: 'f_banners', nameAr: 'Banner', slug: 'banners', order: 2 },
 ],
 },
